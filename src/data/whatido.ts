...
export const whatIDo: WhatIDoItem[] = [
  {
    ...
    description: "I run the infrastructure, governance, and self-service tooling that data teams work on top of.",
  ...
  },
  {
    ...
    description: "I write pipelines with Airflow, Spark, and Kafka, plus the testing and monitoring that keeps them reliable.",
  ...
  },
  {
    ...
    description: "I build AI agents, MCP servers, and LLM tools on top of the data platform.",
